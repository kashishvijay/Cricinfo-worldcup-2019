/* the purpose of this project is to extract the information of worldcup 2019 from cricinfo and present it in the 
form of excel and pdf of scorecard. 
The real purpose is to learn how to extract information and get experienced with js.
A very good reason to ever make a project is to have a good fun. */

/* 1. Read data from a source : cricinfo worldcup 2019 (axios)
   2. Process data : Get all teams (jsdom)
   3. Write the procced data in excel and store match results per teams in thier own sheet (excel4node)
   4. Create folder:one for each team (fs)
   5. Write files : pdf file for scorecard of each match in reelevant folder.
*/
...
// npm install pdf-lib
// node Project1.js --excel=Worldcup.csv --dataDir=worldcup --source=https://www.espncricinfo.com/series/icc-cricket-world-cup-2019-1144415/match-results
